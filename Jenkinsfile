pipeline {
    ...
    stages {
        ...
        stage('Initializing Terraform') {
            steps {
                sh 'docker run --rm -it -v $PWD:/data -v /var/run/docker.sock:/var/run/docker.sock -v /var/lib/docker:/var/lib/docker -w /data hashicorp/terraform:latest init -upgrade'
            }
        }
